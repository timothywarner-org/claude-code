...
Environment Variables:
    HELLO_WORLD_MCP_SERVER_DATA_PATH: Path to data file (default: ./data/hello-world-mcp-server.json)
"""
...
DATA_PATH = Path(os.environ.get("HELLO_WORLD_MCP_SERVER_DATA_PATH", "./data/hello-world-mcp-server.json"))
...
Use the hello-world-mcp-server://items resource to access the data.
...
if __name__ == "__main__":
    print(f"Starting hello-world-mcp-server server...", file=sys.stderr)
    print(f"Data path: {DATA_PATH.absolute()}", file=sys.stderr)
    print("", file=sys.stderr)
    print("To add to Claude Code:", file=sys.stderr)
    print(f"  claude mcp add hello-world-mcp-server -- python {Path(__file__).absolute()}", file=sys.stderr)
    print("", file=sys.stderr)
